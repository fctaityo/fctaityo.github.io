...
.s13-dashboard .guide-open-orbit{display:none!important}
...
<button class="project-card active-card" data-open-ri2="" type="button"><span class="project-icon green">⬡</span><span class="ri2-card-copy"><b><em>RI#2</em><span class="ri2-card-title">ドキュメント制作</span></b><small><span>Document Transformation</span><span class="ri2-phase-chip">PHASE B</span></small></span><mark>READY</mark><i class="card-trace"></i></button>
