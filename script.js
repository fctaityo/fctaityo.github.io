...
<button class="project-card active-card" data-open-ri2="" type="button"><span class="project-icon green">⬡</span><span class="ri2-card-copy"><b><em>RI#2</em> ドキュメント制作</b><small>Document Transformation / Phase B</small></span><mark>READY</mark><i class="card-trace"></i></button>
