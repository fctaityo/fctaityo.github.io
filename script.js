...
<div class="section-number">04 <span>/</span></div>
<div><h1>実証プロジェクト</h1><p class="section-en">REFERENCE IMPLEMENTATIONS</p><p class="section-copy">複数の開発ラインを同時に進行し、仮説を実装とEvidence（証拠）で確かめていく。</p></div>
</div>
...
<article class="project-line other-line"><div class="line-static"><span class="line-id"><i>◉</i><b>RI#2</b></span><span class="line-name"><strong>ドキュメント制作</strong><small>Parallel Reference Implementation</small></span><span class="chevron">⌄</span></div><div class="mini-rail"><i class="g"></i><i class="g"></i><i class="c"></i><i class="v"></i><i></i></div></article>
...
<article class="project-line other-line"><div class="line-static"><span class="line-id"><i>⬡</i><b>CORE</b></span><span class="line-name"><strong>Foundry Core</strong><small>Core Candidate / Evidence蓄積</small></span><span class="chevron">⌄</span></div><div class="mini-rail"><i class="g"></i><i class="v"></i><i></i><i></i><i></i></div></article>
<article class="project-line other-line"><div class="line-static"><span class="line-id"><i>✣</i><b>RI#3</b></span><span class="line-name"><strong>次期Reference Implementation</strong><small>Future target</small></span><span class="chevron">⌄</span></div><div class="mini-rail"><i class="v"></i><i></i><i></i><i></i><i></i></div></article>
</section>
</div>
